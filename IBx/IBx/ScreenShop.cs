    ...
    public class ScreenShop
    {
        ...
        public void setControlsStart()
        {
            ...
            if (btnAll == null)
            {
                ...
                btnAll.Text = "ALL";
                btnAll.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnAll.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
            ...
            if (btnWeapons == null)
            {
                ...
                btnWeapons.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnWeapons.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
            ...
            if (btnArmors == null)
            {
                ...
                btnArmors.Text = "WEAR";
                btnArmors.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnArmors.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
            ...
            if (btnGeneral == null)
            {
                ...
                btnGeneral.Text = "GEN";
                btnGeneral.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnGeneral.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
            ...
            if (btnInfoShop == null)
            {
                ...
                btnInfoShop.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnInfoShop.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
            ...
            if (btnAllShop == null)
            {
                ...
                btnAllShop.Text = "ALL";
                btnAllShop.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnAllShop.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
            ...
            if (btnWeaponsShop == null)
            {
                ...
                btnWeaponsShop.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnWeaponsShop.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
            ...
            if (btnArmorsShop == null)
            {
                ...
                btnArmorsShop.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnArmorsShop.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
            ...
            if (btnGeneralShop == null)
            {
                ...
                btnGeneralShop.Img = "btn_small"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small);
                btnGeneralShop.Glow = "btn_small_glow"; // BitmapFactory.decodeResource(gv.getResources(), R.drawable.btn_small_glow);
        ...
        public void redrawShop()
        {
            ...
            */
            ...
            gv.DrawText(currentShop.shopName, 3 * gv.squareSize - 2 * pW, locY + 1.5f * gv.squareSize, 1.0f, "gray");
            ...
            gv.DrawText("Buys at: " + totalBuyPerc + "%, sells at: " + totalSellPerc + "%", 8 * gv.squareSize + (int)(0.5f * gv.squareSize) + (int)(0.75f * pW), locY + 1.5f * gv.squareSize, 1.0f, "blue");
            ...
            gv.DrawText("Party Inventory", gv.squareSize * 3 - 2 * pW, locY + gv.squareSize - 2 * pH, 1.0f, "gray");
            ...
            gv.DrawText(gv.mod.goldLabelPlural + ": " + gv.mod.partyGold, 8 * gv.squareSize + (int)(0.5f * gv.squareSize) + (int)(0.75f * pW), locY + gv.squareSize - 2 * pH, 1.0f, "yellow");
        ...
        public async void doInventoryActions()
        {
            if (generalFilterOn)
            {
                if ((inventorySlotIndex + (inventoryPageIndex * 10)) < generalRefs.Count)
                {
                    bool answer = await gv.cp.DisplayAlert("Question?", "Do you wish to sell this item?", "Yes", "No");
                    if (answer)                        
                    {
                        //sell item
                        ItemRefs itr = generalRefs[inventorySlotIndex + (inventoryPageIndex * 10)];
        ...
        public async void doShopActions()
        {
            if (generalFilterOnShop)
            {
                if ((shopSlotIndex + (shopPageIndex * 10)) < generalRefsShop.Count)
                {
                    ...
                    bool answer = await gv.cp.DisplayAlert("Question?", "Do you wish to buy this item?", "Yes", "No");
                    if (answer)
                    {
                        //buy item
