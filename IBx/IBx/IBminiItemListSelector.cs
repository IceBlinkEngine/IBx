    ...
    public class IBminiItemListSelector
    {
        ...
        public void setControlsStart()
        {
            ...
            for (int y = 0; y < itemList.Count; y++)
            {
                ...
                btnNew.Y = (int)(currentLocY * gv.screenDensity) + ((y + 1) * (int)(gv.screenDensity * 0.65f)) + (y * padW);
                btnNew.Height = (int)(gv.ibbheight * gv.screenDensity * 0.75f);
                btnNew.Width = (int)(gv.ibbwidthL * gv.screenDensity * 3.25f);
        ...
        public void drawItemListSelection()
        {
            ...
            //DRAW TEXT		
            int textWidth = (int)gv.MeasureString(HeaderText, "regular", "normal");
