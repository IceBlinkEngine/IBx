...
namespace IBx
{
    public class ScreenPartyRoster
    {
        ...
        public void redrawPartyRoster()
        {
            ...
            gv.DrawText("Current Party Members [" + gv.mod.MaxPartySize + " Maximum]", ulX, pH * 3, 1.0f, "gray");
            ...
            gv.DrawText("Party Roster [Players in Reserve]", ulX, 3 * gv.squareSize + (pH * 0), 1.0f, "gray");
